...
| `DeviceManagementManagedDevices.Read.All` | [Compliance overview](../agents/compliance-overview.md)<br>[Find inactive devices](../agents/find-inactive-devices.md)<br>[Offboarding agent](../agents/offboarding-agent.md)<br>[OS update posture](../agents/os-update-posture.md)<br>[Tenant health report](../agents/tenant-health-report.md) |
